...
return array(
    ...
    "operator_panel"            => "Painel de Operador",
    "welcome"                   => "Bemvindo ao SupportPal",
    "welcome_desc"              => "Tomou a decisão certa. Clique para começar um pequeno guia de produto das nossas opções e funcionalidades.",

    // Dashboard
    "submit_ticket"             => "Submeter Ticket",
    "submit_ticket_desc"        => "Utilize este formulário para submeter um pedido de suporte à nossa equipa!",
    "track_ticket"              => "Verificar um Ticket",
    "track_ticket_desc"         => "Não está registado? Utilize o seu endereço de e-mail e o número do ticket para verificar o estado do mesmo.",
    "my_tickets"                => "Os meus Tickets",
    "my_tickets_desc"           => "Localize os seus Tickets. Pode encontrar os seus Tickets ativos e os anteriormente resolvidos.",
    "no_modules"                => "Sem módulos ativos.",
    "search_results"            => "Resultados da pesquisa",
    "found_results"             => "Encontrados :total resultados para o(s) termo(s) pesquisado(s)",
    ...
    "license_code"              => "Código da License",
    "change_license"            => "Alterar Licença",
    "license_info"              => "Informação da Licença",
    "license_owner"             => "Titular da Licença",
    "license_created"           => "Licença Criada",
    "license_type"              => "Tipo de Licença",
    "branding"                  => "Branding",
    "license_expires"           => "Licença Expira",
    "license_valid_ip"          => "IPs Válidos da Licença",
    "support_status"            => "Estado do Suporte",
    "support_expires"           => "Suporte Expira",
    "version_info"              => "Informação da Versão",
    "installed_version"         => "Versão Instalada",
    "available_version"         => "Versão Disponível",
    "monthly_product"           => "* A data de expiração irá automaticamente ajustar-se mensalmente conforme as faturas forem liquidadas.",
    ...
    "containing_text"           => "Contendo Texto",
    "filter_new_message"        => "Nova Mensagem de Ticket (do Utilizador)",
    "filter_new_comment"        => "Novo Comentário do Self-Service (do Utilizador)",
    "filter_user_login"         => "Login de Utilizador",
    "filter_operator_login"     => "Login de Operador",
    "filter_api_access"         => "Acesso API",
    "content"                   => "Conteúdo",
    "sender"                    => "Remetente",
    "content_sender"            => "Conteúdo & Remetente",

    // Company
    "company"                   => "Empresa|Empresas",

    // Email
    "default_email_addr"        => "Endereço de E-mail Default",
    "default_email_addr_desc"   => "O endereço de e-mail que será utilizado no campo de remetente na maioria dos e-mails enviados pelo sistema.",
    "include_operator_name"     => "Incluir Nome do Operador",
    ...
    "global_email_header"       => "Cabeçalho de E-mail Global",
    "global_email_header_desc"  => "Adicione um cabeçalho a todos os e-mails enviados pelo sistema. HTML é aceite.",
    "global_email_footer"       => "Rodapé de E-mail Global",
    "global_email_footer_desc"  => "Adicione um rodapé a todos os e-mails enviados pelo sistema. HTML é aceite.",
    "email_template"            => "Email Template|Email Templates",
    "email_log"                 => "Registos de Email",
    "email_queue"               => "Lista de Espera de Emails",
    "email_queue_desc"          => "Below are the emails that are queued to be sent out soon by the cron.",
    "email_method"              => "Método de Email",
    "php_mail_function"         => "Função PHP mail()",
    "smtp"                      => "SMTP",
    ...
    "module_disable"            => "Módulos desactivados serão removidos da interface de frontend e operador.",

    // Scheduled tasks
    "scheduled_task"            => "Tarefa Agendada|Tarefas Agendadas",
    "interval_desc"             => "Define a frequência com que esta tarefa é executada, por exemplo definindo 5 minutos significa que a tarefa irá correr de 5 em 5 minutos caso a cron esteja activa e em execução.",
    "cron_settings"             => "Definições de Cron",
    "cron_running"              => "Em execução",
    "cron_not_running"          => "Não está a executar",
    "task_ran"                  => "Executou com sucesso a tarefa agendada manualmente.",
    ...
    // System Cleanup
    "system_cleanup"            => "Limpeza de Sistema",
    ...
    "enable_tour"               => "Activar Guia de Produto",
   ...
   // General Settings
    ...
    "admin_folder_desc"         => "Define o nome da pasta para o painel de operador. É recomendado alterar a pasta padrão \"admin\" de um ponto de vista de segurança",
    "enable_ssl"                => "Activar SSL",
    "maintenance_mode"          => "Modo Manutenção",
    "maintenance_mode_desc"     => "Desactiva as funcionalides publicas do help desk e mostra uma mensagem de manutenção. Edite o ficheiro resources/templates/frontend/[template]/core/maintenance.twig para alterar a mensagem que é mostrada aos utilizadores.",
    "default_user_country"      => "País Padrão do Utilizador",
    "default_user_country_desc" => "O país que será selecionado por omissão quando os utilizadores se registarem.",
    ...
    "simpleauth_key_desc"       => "A chave para a nossa opção sign-on, mínimo 16 caracteres.",
    "simpleauth_operators"      => "Permitir aos Operadores",
    "base_url"                  => "URL do Sistema",
    "base_url_desc"             => "Insira o endereço completo da sua instalação, utilizado para gerar os URLs que são vistos pelos utilizadores.",
    "debug"                     => "Debug",
    "debug_mode"                => "Modo Debug",
    "pretty_urls"               => "URLs Amigáveis",
    "pretty_urls_desc"          => "Activar irá remover o index.php dos URLs. Apenas active se conseguir aceder ao painel de operador sem o index.php. Desactive caso não tenha o mod_rewrite instalado, os ficheiros .htaccess não sejam permitidos ou caso não tenha convertido as regras de reescrita do .htaccess do Apache de forma a funcionarem com o seu servidor web alternativo.",
     ...
     * 2.0.3
     */
    "enable_ssl_desc"           => "Activar esta opção irá forneçar o frontend e painel de operador a utilizar ligações seguras, como uma definição recomendada. Por favor certifique-se que as funções HTTPS estão definidas no servidor antes de activar.",
    "unexpected_template_error" => "An unexpected error occurred while syntax checking the template. Please try again.",
    "empty_template_preview"    => "Por favor forneça um template válido de forma a utilizar a função de pré-visualização.",
    ...
    "default_brand_desc"        => "Seleciona a marca que será utilizada como pré-definida quando os utilizadores visitarem o frontend e uma marca coincidente não possa ser encontrada.",
    "brand_enabled_desc"        => "Clique para activar ou desactivar a marca. As marcas desactivadas não poderão ser utilizadas e não contarão como parte das marcas permitidas na sua licença. A desactivação poderá ser utilizada para esconder temporariamente a sua marca e/ou reter informação. Eliminar uma marca irá remover toda a informação, incluíndo utilizadores e tickets relacionados com os mesmos.",
    "inherit_global_setting"    => "Assumir Definições Globais",
    "brand_date_format_desc"    => "O formato da data utilizado para o frontend desta marca.",
    "brand_time_format_desc"    => "O formato da hora utilizado para o frontend desta marca.",
    "brand_timezone"            => "Fuso-Horário da Marca",
    "brand_timezone_desc"       => "O fuso-horário que será utilizado por defeito no frontend desta marca. Os utilizadores terão a opção para definir o seu próprio fuso-horário.",
    "brand_default_lang_desc"   => "A língua padrão que é utilizada por defeito para esta marca.",
    "brand_lang_toggle_desc"    => "Se a caixa de seleção de língua deve ser mostrada no frontend desta marca.",
    "brand_groups_desc"         => "Operadores nos grupos seleccionar vão poder criar, actualizar e eliminar (dependendo das permissões de cargo) os tickets e outros conteúdos desta marca.",
    "select_brand"              => "Selecionar uma marca...",
    ...
    "purchase_more"             => "Comprar mais",
    "brand_limit_allowed"       => "A sua licença está actualmente permitida para usar :allowed marca simultaneamente.|A sua licença está actualmente permitida para usar :allowed marcas simultaneamente.",
    ...
    "support_expiry"            => "A sua subscrição de suporte e actualizações é válida até :date.",
    ...
    "php_info"                  => "Informação PHP",
    "log"                       => "Registo|Registos",
     ...
     * 2.1.1
     */
    "file_manager"              => "Gestor de Ficheiros Log",
    ...
    "and_number_others"         => "e :number outro|e :number outros",
    "user_templates"            => "Templates de Utilizador",
    "operator_templates"        => "Templates de Operador",

    /*
     * 2.2.0
     */
    "attachment_size"           => "Tamanho Máximo Acumulado de Anexos",
    "attachment_size_desc"      => "O tamanho máximo acumulado de todos os anexos que são enviados num único e-mail. As opções disponíveis são K (para Kilobytes) e M (para Megabytes), tudo o resto será assumido como bytes. Valor Exemplo: 5M para 5 Megabytes. Definir 0 para não enviar qualquer anexo por e-mail e obrigar os utilizadores a descarregarem os anexos através do helpdesk.",
    ...
    "getting_started"           => "Guia de Iniciação",
    "operator_notes"            => "Notas de Operador",
    ...
    "upgrade_and_reactivate"    => "Upgrade & Reactivar",
   ...
   /*
    ...
    "brand_colour_desc"         => "Selecione uma cor para a sua marca, que será utilizada para o esquema de cores do frontend e do painel de operador. Deixe em branco para utilizar o esquema de cores pré-definido.",
    "favicon"                   => "Favicon",
    "favicon_desc"              => "A imagem de favicon aparece na barra de endereço e é utilizada para identificar o seu website. Para melhores resultados, certifique-se que a imagem contem um tamanho de 32x32px a 310x310px, é quadrada e tem formato ICO/PNG.",
    ...
    "reprocess_email"           => "Reprocessar Email",
    ...
    "export_data_desc"          => "Gerar uma exportação de dados pertencente a este utilizador.",
    ...
    "no_branding"               => "Sem Branding",
    "no_branding_desc"          => "Remove o branding do SupportPal da interface do utilizador.",
     ...
     * 2.6.0
     */
    "containing_text_desc"      => "Por favor insira uma string (palavra particular a banir ou endereço de e-mail). Todas as strings são case-insensitive.",
    "spam_is_regex_desc"        => "As regras podem tirar vantagem de expressões regulares; se pretender utilizar, por favor active esta opção. Não necessita de incluir delimitadores.",
    ...
    "logo_dark_mode"            => "Logo Modo Escuro",
    "logo_dark_mode_desc"       => "Se o logo está desenhado para ser utilizado apenas em fundos claros, defina um logo diferente para o modo escuro. O campo poderá ser um caminho relativo à diretoria base (recomendamos que armazene o seu logo na pasta resources/assets/) ou um endereço URL direto para a imagem.",
    "template_mode"             => "Modo do Template",
    "template_mode_desc"        => "Define um tema claro padrão ou tema escuro para a interface. Os utilizadores poderão selecionar as suas próprias preferências nos seus perfis.",
    "light_mode"                => "Modo Claro",
    "dark_mode"                 => "Modo Escuro",
    "logo"                      => "Logo",
    "logo_desc"                 => "Altere o logo padrão para esta marca. O campo poderá ser um caminho relativo à diretoria base (recomendamos que armazene o seu logo na pasta resources/assets/) ou um endereço URL direto para a imagem.",
    "website_url"               => "URL do Website",
    "website_url_desc"          => "Adiciona um link de retorno ao seu site principal no cabeçalho do portal de suporte.",
    "back_to_website"           => "Voltar ao website",
    "template"                  => "Template",
    "how_can_we_help"           => "Em que o podemos ajudar?",
     ...
     * 3.3.0
     */
    "third_party_integrations"  => "Integração de Terceiro|Integrações de Terceiros",
    "oauth"                     => "OAuth",
    "oauth_data"                => "Dados OAuth",
    "client_id"                 => "Client ID",
